...
class shock_claws(Equippable):
    def __init__(self) -> None:
        super().__init__(equipment_type=EquipmentType.WEAPON, attack_bonus=3, attack_times=2, damage_type=DamageType.SHOCK,two_handed=True)
...
class pistol(Equippable):
    def __init__(self) -> None:
        super().__init__(equipment_type=EquipmentType.WEAPON, attack_bonus=3, range_bonus=4,ammo_count=12,ammo_max=12)
