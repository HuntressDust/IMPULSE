...
from IMPULSE.components.description import big_goop
...
class Fighter(BaseComponent):
    ...
    @property
    def reflex(self) -> int:
        return self.base_reflex + self.reflex_bonus
    ...
    def take_damage(self, incoming_damage:int, damagetype:DamageType=DamageType.KINETIC)-> int:
