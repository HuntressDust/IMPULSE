...
class EntityDescriptionHandler(EventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        if hasattr(self.entity,"fighter"):
            ...
            log_console.print_box(
                0, i, log_console.width, 1, f"HP: {fighter.hp},FP: {fighter.fp}, Attack: {fighter.attack}, Defense: {fighter.defense}, Speed: {fighter.speed}", alignment=tcod.CENTER,
            )
            i += 2
            log_console.print_box(
...
class HelpScreen(BaseEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
            ...
            console.print(
                1, 14, "O Examines an Item"
            )
            console.print(
                1, 16, "R Drops an Item"
            )
            console.print(
            1, 18, "L Looks around"
            )
            ...
            console.print(
                1, 29, "You can only equip Cyberware at a Medbay, activate a Medbay with ENTER"
            )

            console.print(
            0, 31, "_____Attributes_____"
            )

            console.print(
                1, 33, "POWER: Your physical prowess"
            )
            console.print(
                5,34,"Affects HP and Melee Damage"
            )
            console.print(
                1, 36, "REFLEX: Your agility and coordination"
            )
            console.print(
                5, 37, "Affects Accuracy and Dodge"
            )
            console.print(
                1, 39, "FOCUS: Your mental faculties"
            )
            console.print(
                5, 40, "Affects FP and Hacking"
            )


            console.print(
                1, 42, "At 10 POWER, you gain +6 carry capacity"
            )
            console.print(
                1, 44, "At 10 REFLEX, you gain +1 movement speed"
            )
            console.print(
                1, 46, "At 10 FOCUS, you gain +1 Network slot (you can control 1 more NPC)"
            )
...
class CharacterScreenEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        console.print(
            x=x + 1, y=y + 40, string=f"___NETWORK___ "
        )
        console.print(
