...
from IMPULSE.components.description import Description, default_description
    ...
    def spawn(self: T, gamemap: GameMap, x: int, y: int) -> T:
        ...
        if not self.is_tile_valid(x, y, gamemap):
            try:
                ...
                tile = self.find_close_tile(x+1, y+1, gamemap)
                x = tile[0]
                y = tile[1]
        ...
        if perimeter<3:
            ...
            try:
                ...
                try:
                    ...
                    tile=self.find_close_tile(x,y,gamemap,perimeter+2)
                    return tile
