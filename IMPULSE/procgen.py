...
consumable_chances: Dict[int, List[Tuple[Entity, int]]] = {
    ...
    0: [(entity_factories.health_potion, 40),(entity_factories.fp_potion,40),
        (entity_factories.estrogen,20), (entity_factories.weed,20),(entity_factories.personal_shield,20),
        (entity_factories.progesterone,10),(entity_factories.poppers,10),(entity_factories.hypnofile,10),(entity_factories.adrenaline,10),
        (entity_factories.flare,30),(entity_factories.frag_grenade,20),(entity_factories.fire_grenade,10),(entity_factories.ketamine_scroll,30),(entity_factories.lithium_battery,20),
        (entity_factories.pistol_ammo,30),(entity_factories.rifle_ammo,10),(entity_factories.chaingun_ammo,5),],

    2:[(entity_factories.health_potion, 40),(entity_factories.fp_potion,40),
        (entity_factories.estrogen,20), (entity_factories.weed,20),(entity_factories.personal_shield,20),
        (entity_factories.progesterone,10),(entity_factories.poppers,10),(entity_factories.hypnofile,10),(entity_factories.adrenaline,10),
        (entity_factories.flare,20),(entity_factories.frag_grenade,30),(entity_factories.fire_grenade,10),(entity_factories.ketamine_scroll,20),(entity_factories.lithium_battery,20),
        (entity_factories.pistol_ammo,30),(entity_factories.rifle_ammo,20),(entity_factories.chaingun_ammo,10),],

    4:[(entity_factories.health_potion, 30),(entity_factories.fp_potion,30),
        (entity_factories.estrogen,20), (entity_factories.weed,30),(entity_factories.personal_shield,20),
        (entity_factories.progesterone,20),(entity_factories.poppers,30),(entity_factories.hypnofile,20),(entity_factories.adrenaline,20),
        (entity_factories.flare,10),(entity_factories.frag_grenade,20),(entity_factories.fire_grenade,30),(entity_factories.ketamine_scroll,20),(entity_factories.lithium_battery,20),
        (entity_factories.pistol_ammo,30),(entity_factories.rifle_ammo,15),(entity_factories.chaingun_ammo,10),],


    6:[(entity_factories.health_potion, 40),(entity_factories.fp_potion,40),
        (entity_factories.estrogen,20), (entity_factories.weed,20),(entity_factories.personal_shield,20),
        (entity_factories.progesterone,10),(entity_factories.poppers,10),(entity_factories.hypnofile,10),(entity_factories.adrenaline,20),
        (entity_factories.flare,10),(entity_factories.frag_grenade,30),(entity_factories.fire_grenade,20),(entity_factories.ketamine_scroll,20),(entity_factories.lithium_battery,20),
        (entity_factories.pistol_ammo,20),(entity_factories.rifle_ammo,20),(entity_factories.chaingun_ammo,20),],



    8:[(entity_factories.health_potion, 30),(entity_factories.fp_potion,30),
...
enemy_chances: Dict[int, List[Tuple[Entity, int]]] = {
    ...
    0: [(entity_factories.corpo_sentry,60),(entity_factories.corpo_drone,80),(entity_factories.big_goop,30)],

    2: [(entity_factories.corpo_sentry,80),(entity_factories.corpo_drone,60),(entity_factories.big_goop,40),(entity_factories.doll,10),(entity_factories.latex_drone,10)],

    3: [(entity_factories.corpo_sentry,60),(entity_factories.corpo_drone,60),(entity_factories.big_goop,20),
        (entity_factories.doll,20),(entity_factories.latex_drone,30)],

    4: [(entity_factories.corpo_sentry,60),(entity_factories.big_goop,20),
        (entity_factories.doll,20),(entity_factories.latex_drone,30),(entity_factories.latex_sentry,30),
        (entity_factories.chaser,30)],

    6: [(entity_factories.latex_drone,40),(entity_factories.latex_sentry,40),
        (entity_factories.security_enforcer,30),(entity_factories.security_bot,20),
        (entity_factories.chaser,30),(entity_factories.combat_doll,10),(entity_factories.doll,20)],

    7:[(entity_factories.latex_drone,30),(entity_factories.latex_sentry,40),
        (entity_factories.security_enforcer,60),(entity_factories.security_bot,40),
        (entity_factories.chaser,20),(entity_factories.combat_doll,30),(entity_factories.doll,20),(entity_factories.exterminator,20),(entity_factories.charger,20)],


    8: [(entity_factories.latex_drone,20),(entity_factories.latex_sentry,20),
        (entity_factories.security_enforcer,60),(entity_factories.security_bot,50),
        (entity_factories.combat_doll,40),(entity_factories.doll,10),(entity_factories.exterminator,30),(entity_factories.charger,30)]

}

equipment_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [(entity_factories.rapier, 20), (entity_factories.pistol, 50), (entity_factories.misericorde, 50),
        (entity_factories.leather_jacket, 30)],

    1: [(entity_factories.rapier, 20), (entity_factories.pistol, 50), (entity_factories.misericorde, 50),
        (entity_factories.leather_jacket,30),(entity_factories.dress,30),
        (entity_factories.los_upgrade,20),(entity_factories.hack_upgrade,20),
        (entity_factories.sheilding, 20), (entity_factories.fire_shielding, 20),
        (entity_factories.bionic_arm, 20), (entity_factories.reflex_upgrade, 20),
        (entity_factories.super_legs, 20), (entity_factories.power_legs, 20)
        ],

    2: [(entity_factories.shock_claws, 20), (entity_factories.assaultRifle, 50), (entity_factories.rapier, 30),
        (entity_factories.hazard_suit,30),(entity_factories.dress,30),
        (entity_factories.accuracy_upgrade,20),(entity_factories.hack_upgrade,20),
        (entity_factories.carrymod, 20), (entity_factories.fire_shielding, 20),
        (entity_factories.bionic_arm, 20), (entity_factories.reflex_upgrade, 20),
        (entity_factories.super_legs, 20), (entity_factories.power_legs, 20)
        ],


    3: [(entity_factories.shock_claws, 20), (entity_factories.assaultRifle, 20), (entity_factories.rapier, 10),
        (entity_factories.hazard_suit,30),(entity_factories.dress,30),(entity_factories.latexBodySuit,30),(entity_factories.jumpsuit,30),
        (entity_factories.accuracy_upgrade,20),(entity_factories.control_upgrade,20),
        (entity_factories.carrymod, 20), (entity_factories.electric_sheilding, 20),
        (entity_factories.bionic_arm, 20), (entity_factories.reflex_upgrade, 20),
        (entity_factories.super_legs, 20), (entity_factories.power_legs, 20)
        ],

    5: [(entity_factories.shock_claws, 20), (entity_factories.assaultRifle, 20), (entity_factories.chainGun, 20),
        (entity_factories.hazard_suit,30),(entity_factories.dress,30),(entity_factories.jumpsuit,30),
        (entity_factories.accuracy_upgrade,20),(entity_factories.control_upgrade,20),
        (entity_factories.weapon_slot, 20), (entity_factories.electric_sheilding, 20),
        (entity_factories.bionic_arm, 20), (entity_factories.reflex_upgrade, 20),
        (entity_factories.super_legs, 20), (entity_factories.power_legs, 20)
        ],

    6: [(entity_factories.shock_claws, 20), (entity_factories.assaultRifle, 20), (entity_factories.chainGun, 30),
        (entity_factories.hazard_suit,30),(entity_factories.dress,30),(entity_factories.jumpsuit,30),
        (entity_factories.accuracy_upgrade,20),(entity_factories.control_upgrade,20),
        (entity_factories.weapon_slot, 20), (entity_factories.boobs, 20),
        (entity_factories.bionic_arm, 20), (entity_factories.reflex_upgrade, 20),
        (entity_factories.super_legs, 20), (entity_factories.power_legs, 20)
        ],

    7: [(entity_factories.shock_claws, 20), (entity_factories.assaultRifle, 20), (entity_factories.chainGun, 30),(entity_factories.labrys,20),
        (entity_factories.hazard_suit,30),(entity_factories.dress,30),(entity_factories.latexBodySuit,30),(entity_factories.jumpsuit,30),
        (entity_factories.hack_upgrade,20),(entity_factories.los_upgrade,20),
        (entity_factories.sheilding, 20), (entity_factories.boobs, 20),
        (entity_factories.carrymod, 20), (entity_factories.reflex_upgrade, 20),
        (entity_factories.super_legs, 20), (entity_factories.power_legs, 20)
        ],
...
def generate_rooms(leaf, rooms: List[RectangularRoom], dungeon):
    ...
    if room1_center is not None and room2_center is not None:
        for x, y in tunnel_between(room1_center, room2_center):
            place_entities(room2_center, dungeon, dungeon.engine.game_world.current_floor)
            place_entities(room1_center, dungeon, dungeon.engine.game_world.current_floor)
...
def generate_BSP(
    ...
    for minion in player.controller.minion_list:
        minion.place(center_of_last_room[0],center_of_last_room[1], dungeon)

    rand_room_number = random.randint(1,len(rooms)-1)
